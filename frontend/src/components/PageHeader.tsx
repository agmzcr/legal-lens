...
export default function PageHeader({ title, backTo, actionButton, searchInput }: PageHeaderProps) {
  ...
  <div className="flex items-center gap-4">
    ...
    <h1 className="text-2xl font-semibold text-gray-800 break-words max-w-full overflow-hidden text-ellipsis whitespace-nowrap sm:whitespace-normal">{title}</h1>
  </div>
